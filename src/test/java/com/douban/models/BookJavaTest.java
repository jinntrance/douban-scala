...
public class BookJavaTest extends BaseJavaTest {
    ...
    public void testTheAnnotationsOfBook() {
        prettyJSON(Book.annotationsOf(bookId, new AnnotationSearch("collect", 2,15,"","")));
    }
    @Test public void testTheBookAnnotationOfUser() {
        prettyJSON(Book.annotationsOfUser(userId,new ListSearchPara(1,15)));
    }
...
//        prettyJSON(Book.deleteReview(review.id))
    ...
    @Test public void testCollectionOfUser() {
        prettyJSON(Book.collectionsOfUser(userId,new CollectionSearch("read","",0,"","",1,15)));
    }
